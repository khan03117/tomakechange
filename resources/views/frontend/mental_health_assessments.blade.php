            ...
            <div class="row">
                    ...
                    <h3 class="text-warning section-title">
                       Mental Health Assessments
                        ...
                        <h3 class="text-warning pb-2">
                       Few of our Assessments are :
                    </h3>
                    <p>Assessing Academic Stress 	-  Meant for Students</p>
                    <p>Anxiety Assessment Test 		- For any Individual</p>
                    <p>Marriage Adjustment Assessment 	- For Married Couples</p>
                </div>
                ...
                <div class="w-100 px-md-5">
                    <div class="card">
                        <div class="card-body">
                            ...
                            <form method="post" action="{{ route('mental_health_contact') }}">
                                @csrf
